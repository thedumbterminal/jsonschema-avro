...
export type AvroComplexType =  avsc.EnumType | avsc.NamedType | AvroSchemaArrayType | AvroSchemaRecordType;
export type AvroSchemaArrayField = AvroSchemaField & { type: AvroSchemaArrayType };
