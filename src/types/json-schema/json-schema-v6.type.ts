...
export const JSONSchema6ObjectSchema = z.record(
  z.string(),
...
export const JSONSchema6BaseSchema = z.object({
  ...
  type: z
    .union([JSONSchema6TypeNameSchema, JSONSchema6TypeNameSchema.array()])
    .optional(),
...
export const JSONSchema6Schema: z.ZodType<JSONSchema6> =
  JSONSchema6BaseSchema.extend({
    items: z.lazy(() =>
      z
        .union([
          JSONSchema6DefinitionSchema,
          JSONSchema6DefinitionSchema.array(),
        ])
        .optional()
    ),
    ...
    contains: z.lazy(() =>
      z.record(z.string(), JSONSchema6DefinitionSchema).optional()
    ),
    ...
    dependencies: z.lazy(() =>
      z
        .record(
          z.string(),
          z.union([JSONSchema6DefinitionSchema, z.string().array()])
        )
        .optional()
    ),
    definitions: z.lazy(() =>
...
export const JSONSchema6DefinitionSchema = z.union([
  JSONSchema6Schema,
  z.boolean(),
])
