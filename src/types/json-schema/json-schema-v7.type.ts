...
export const JSONSchema7ObjectSchema = z.record(
  z.string(),
...
export const JSONSchema7BaseSchema = z.object({
  ...
  type: z
    .union([JSONSchema7TypeNameSchema, JSONSchema7TypeNameSchema.array()])
    .optional(),
...
export const JSONSchema7Schema: z.ZodType<JSONSchema7> =
  JSONSchema7BaseSchema.extend({
    $defs: z.lazy(() =>
      z.record(z.string(), JSONSchema7DefinitionSchema).optional(),
    ),
    items: z.lazy(() =>
      z
        .union([
          JSONSchema7DefinitionSchema,
          JSONSchema7DefinitionSchema.array(),
        ])
        .optional(),
    ),
    ...
    dependencies: z.lazy(() =>
      z
        .record(
          z.string(),
          z.union([JSONSchema7DefinitionSchema, z.string().array()]),
        )
        .optional(),
    ),
...
export const JSONSchema7DefinitionSchema = z.union([
  JSONSchema7Schema,
  z.boolean(),
])
